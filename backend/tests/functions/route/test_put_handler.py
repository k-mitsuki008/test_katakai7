...
module = import_module('src.functions.route.put_handler')
...
def test_handler_ok_01(mocker):
    ...
    event = get_event(body=input_body, gigya_uid='test_uid_01', path='/route', path_parameters={
        'route_id': '1'
    })
    context = {}

    # service.route_service.update_route のモック化
    mocker.patch(
        "service.route_service.update_route",
        return_value={
            'route_id': 123,
            'user_vehicle_id': 1,
...
@pytest.mark.parametrize(
    ['route_id', 'user_vehicle_id', 'origin_name', 'origin_latitude', 'origin_longitude', 'origin_place_id',
     'destination_name', 'destination_latitude', 'destination_longitude', 'destination_place_id', 'save_timestamp',
     'ride_date', 'weather','weather_icon', 'one_ways', 'bicycle_parking', 'error_value_name', 'error_code',
     'error_message'],
    [
        ('1', '1', '出発地', 90.0, 90.0, 'abcd123', '目的地', 90.0, 90.0, 'abcd123', '2023-10-10T10:10:10.000Z',
         '2023-10-23', '001', '001',
        ...
        ('1', 1, 123, 90.0, 90.0, 'abcd123', '目的地', 90.0, 90.0, 'abcd123', '2023-10-10T10:10:10.000Z',
         '2023-10-23', '001', '001',
         [{'route_type_branch_no': 1, 'round_trip_type_code': '10', 'duration': 123,
           'distance': 123, 'route_type': '12',
           'route_via_points': [{'route_via_point_type': '01', 'route_via_point_place_id': 'abcde1236',
        ...
        ('1', 1, '出発地', 90.0, 90.0, 123, '目的地', 90.0, 90.0, 'abcd123', '2023-10-10T10:10:10.000Z',
         '2023-10-23', '001', '001',
         [{'route_type_branch_no': 1, 'round_trip_type_code': '10', 'duration': 123,
           'distance': 123, 'route_type': '12',
           'route_via_points': [{'route_via_point_type': '01', 'route_via_point_place_id': 'abcde1236',
        ...
        ('1', 1, '出発地', 90.0, 90.0, 'abcd123', 123, 90.0, 90.0, 'abcd123', '2023-10-10T10:10:10.000Z',
         '2023-10-23', '001', '001',
         [{'route_type_branch_no': 1, 'round_trip_type_code': '10', 'duration': 123,
           'distance': 123, 'route_type': '12',
           'route_via_points': [{'route_via_point_type': '01', 'route_via_point_place_id': 'abcde1236',
        ...
        ('1', 1, '出発地', 90.0, 90.0, 'abcd123', '目的地', 90.0, 90.0, 1234, '2023-10-10T10:10:10.000Z',
         '2023-10-23', '001', '001',
         [{'route_type_branch_no': 1, 'round_trip_type_code': '10', 'duration': 123,
           'distance': 123, 'route_type': '12',
           'route_via_points': [{'route_via_point_type': '01', 'route_via_point_place_id': 'abcde1236',
        ...
        ('1', 1, '出発地', 90.0, 90.0, 'abcd123', '目的地', 90.0, 90.0, 'abcd123', '2023-10-10 10:10:10.000Z',
         '2023-10-23', '001', '001',
         [{'route_type_branch_no': 1, 'round_trip_type_code': '10', 'duration': 123,
           'distance': 123, 'route_type': '12',
           'route_via_points': [{'route_via_point_type': '01', 'route_via_point_place_id': 'abcde1236',
...
def test_handler_ng_01(
        mocker, route_id, user_vehicle_id, origin_name, origin_latitude, origin_longitude, origin_place_id,
        destination_name, destination_latitude, destination_longitude, destination_place_id, save_timestamp,
    ...
    event = get_event(body=input_body, gigya_uid='test_uid_01', path='/user', path_parameters={
        'route_id': route_id
    })
    context = {}
